...
<head>
    ...
    <style>
        ...
        th, td { padding:12px 14px; text-align:left; border-bottom:1px solid #222;
        ...
        .avatar { width:48px; height:48px; object-fit:cover;
                  border-radius:50%; border:2px solid #333; background:#222; }
        .order-badge { display:inline-block; background:#1a1a1a; border:1px solid #e10600;
                       color:#e10600; width:24px; height:24px; border-radius:50%;
                       text-align:center; line-height:24px; font-size:.78rem; font-weight:bold; }
        .nav-back { display:inline-block; margin-bottom:24px; color:#888;
                    text-decoration:none; font-size:.85rem; }
        .nav-back:hover { color:#fff; }
        .hint { font-size:.78rem; color:#555; margin-top:-12px; margin-bottom:14px; }
    </style>
</head>
<body>
